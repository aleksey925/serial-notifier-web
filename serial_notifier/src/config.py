...
class BaseConfig:
    def __init__(self):
        self.PROJECT_ROOT_DIR = Path(__file__).absolute().parent.parent
        self.APP_ROOT_DIR = Path(__file__).absolute().parent
...
class TestConfig(DevConfig):
    def __init__(self):
        ...
        # test data
        self.FIXTURES_PATH = str(self.APP_ROOT_DIR / 'tests' / 'fixtures')
